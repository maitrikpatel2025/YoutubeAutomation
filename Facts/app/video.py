...
for image_file in image_files:
    ...
    effect = random.choice([add_image_with_fade, add_image_with_zoom, add_image_with_blur, add_image_with_blur, add_image_with_iris, add_image_with_blur, add_image_with_blur, add_image_with_fade,
                             add_image_with_iris, add_image_with_fade, add_image_with_zoom,add_image_with_iris])
